...
#### string GetDeviceNameByIdx ( integer controllerIdx ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
Returns the name of the device associated with the specified controller index.

___

### GetMouseWheel () {: aria-label='Functions' }
#### [Vector](Vector.md) GetMouseWheel ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
Returns the mouse wheel's current scroll amount.
