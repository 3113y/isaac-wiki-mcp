...
### __add () {: aria-label='Operators' }
#### [Vector](Vector.md) __add ( [Vector](Vector.md) Right ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Operators' }
Fixed version of the original function that prevents a crash when the left operand of the vector calculation is nil.
...
### __div () {: aria-label='Operators' }
#### [Vector](Vector.md) __div ( float Modifier ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Operators' }
#### [Vector](Vector.md) __div ( [Vector](Vector.md) Right ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Operators' }
Fixed version of the original function that prevents a crash when the left operand of the vector calculation is nil.
...
### __mul () {: aria-label='Operators' }
#### [Vector](Vector.md) __mul ( float Modifier ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Operators' }
#### [Vector](Vector.md) __mul ( [Vector](Vector.md) Right ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Operators' }
Fixed version of the original function that prevents a crash when the left operand of the vector calculation is nil.
...
### __sub () {: aria-label='Operators' }
#### [Vector](Vector.md) __sub ( [Vector](Vector.md) Right ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Operators' }
Fixed version of the original function that prevents a crash when the left operand of the vector calculation is nil.
...
#### void FromAngle ( float Angle ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
