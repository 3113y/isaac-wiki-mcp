...
#### [LevelStage](https://wofsauge.github.io/IsaacDocs/rep/enums/LevelStage.html) GetLastDevilRoomStage ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Modified Functions' }
...
#### [LevelStage](https://wofsauge.github.io/IsaacDocs/rep/enums/LevelStage.html) GetLastLevelWithDamage ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Modified Functions' }
Now returns an integer instead of unusable userdata.
...
#### [LevelStage](https://wofsauge.github.io/IsaacDocs/rep/enums/LevelStage.html) GetLastLevelWithoutHalfHp ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Modified Functions' }
Now returns an integer instead of unusable userdata.
...
#### [EntityPlayer](EntityPlayer.md) GetPlayer ( int Index ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Modified Functions' }
...
#### void MoveToRandomRoom ( boolean IAmErrorRoom, int Seed, [EntityPlayer](EntityPlayer.md) Player ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Modified Functions' }
...
#### void StartStageTransition ( boolean SameStage, int TransitionOverride, [EntityPlayer](EntityPlayer.md) Player = nil ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Modified Functions' }
...
#### boolean AchievementUnlocksDisallowed ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### void AddDebugFlags ( [DebugFlag](enums/DebugFlag.md) Flag ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### void AddShopVisits ( int Count ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
Increases the number of shops the player has entered this run.

___

### ChainLightning () {: aria-label='Functions' }
#### [EntityEffect](EntityEffect.md) ChainLightning ( [Vector](Vector.md) Position, float BaseDamage = 3.5, [TearFlags](https://wofsauge.github.io/IsaacDocs/rep/enums/TearFlags.html) TearFlags = TearFlags.TEAR_NORMAL, [Entity](Entity.md) Spawner = nil ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### ClearErasedEnemies () {: aria-label='Functions' }
#### void ClearErasedEnemies ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
Clears all enemies listed as erased, allowing them to spawn again.

___

### DevolveEnemy () {: aria-label='Functions' }
#### void DevolveEnemy ( [Entity](Entity.md) ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
Devolves an enemy as if the D10 item had been used on it.

___

### GetChallengeParams () {: aria-label='Functions' }
#### [ChallengeParam](ChallengeParam.md) GetChallengeParams ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### int GetDebugFlags ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
Returns a [DebugFlag](enums/DebugFlag.md) bitmask.

___

### GetDizzyAmount () {: aria-label='Functions' }
#### float GetDizzyAmount ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
Returns the current dizzy amount, akin to Wavy Cap.

___

### GetGenericPrompt () {: aria-label='Functions' }
#### [GenericPrompt](GenericPrompt.md) GetGenericPrompt ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### [ColorModifier](ColorModifier.md) GetLerpColorModifier ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### [PauseMenuStates](enums/PauseMenuStates.md) GetPauseMenuState ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### GetPlanetariumsVisited () {: aria-label='Functions' }
#### int GetPlanetariumsVisited ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
Returns the number of planetariums the player has entered this run.

___

### GetShopVisits () {: aria-label='Functions' }
#### int GetShopVisits ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### boolean IsErased ( [Entity](Entity.md) Entity ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
#### boolean IsErased ( int Type, int Variant = -1, int SubType = -1 ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
Checks if an entity was erased.

___

### IsGreedBoss () {: aria-label='Functions' }
#### boolean IsGreedBoss ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### boolean IsGreedFinalBoss ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### boolean IsHardMode ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
Returns `true` if the current mode is Hard Mode or Greedier.

___

### IsPauseMenuOpen () {: aria-label='Functions' }
#### boolean IsPauseMenuOpen ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
Returns `true` if the pause menu is open.

___

### IsRerun () {: aria-label='Functions' }
#### boolean IsRerun ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
Returns `true` if the current run is a rerun.

___

### IsStartingFromState () {: aria-label='Functions' }
#### boolean IsStartingFromState ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### void RecordPlayerCompletion ( [CompletionType](enums/CompletionType.md) Type ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### void SetBloom ( float Duration, float Amount ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### void SetDizzyAmount ( float TargetIntensity , float CurrentIntensity ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### void SetDonationModAngel ( int Amount ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### SetDonationModGreed () {: aria-label='Functions' }
#### void SetDonationModGreed ( int Amount ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### ShowGenericLeaderboard () {: aria-label='Functions' }
#### void ShowGenericLeaderboard ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### SpawnBombCrater () {: aria-label='Functions' }
#### [Entity](Entity.md) SpawnBombCrater ( [Vector](Vector.md) Position, float Radius = 1.0 ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
