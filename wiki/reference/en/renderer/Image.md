...
#### number GetWidth ( ) {: .copyable aria-label='Functions' }     [ ](#){: .rgonplus .tooltip .badge }
...
#### number GetHeight ( ) {: .copyable aria-label='Functions' }     [ ](#){: .rgonplus .tooltip .badge }
...
#### number GetPaddedWidth ( ) {: .copyable aria-label='Functions' }     [ ](#){: .rgonplus .tooltip .badge }
...
#### number GetPaddedHeight ( ) {: .copyable aria-label='Functions' }     [ ](#){: .rgonplus .tooltip .badge }
...
#### string GetName ( ) {: .copyable aria-label='Functions' }     [ ](#){: .rgonplus .tooltip .badge }

___

### GetTexelRegion () {: aria-label='Functions' }
#### string GetTexelRegion ( integer x, integer y, integer width, integer height ) {: .copyable aria-label='Functions' }     [ ](#){: .rgonplus .tooltip .badge }
...
#### void Render ( [SourceQuad](SourceQuad.md) sourceQuad, [DestinationQuad](DestinationQuad.md) destinationQuad, [KColor](https://wofsauge.github.io/IsaacDocs/rep/KColor.html) color, [Color](../Color.md) colorMod = Color() ) {: .copyable aria-label='Functions' }     [ ](#){: .rgonplus .tooltip .badge }

___

### RenderWithShader () {: aria-label='Functions' }
#### void RenderWithShader ( [SourceQuad](SourceQuad.md) sourceQuad, [DestinationQuad](DestinationQuad.md) destinationQuad, [KColor](https://wofsauge.github.io/IsaacDocs/rep/KColor.html) color, [Shader](Shader.md) shader, table shaderParams ) {: .copyable aria-label='Functions' }    [ ](#){: .rgonplus .tooltip .badge }
