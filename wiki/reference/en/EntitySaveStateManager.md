...
#### table, boolean GetEntityData ( [ModReference](https://wofsauge.github.io/IsaacDocs/rep/ModReference.html) mod, [Entity](Entity.md) entity ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### table, boolean GetEntitySaveStateData ( [ModReference](https://wofsauge.github.io/IsaacDocs/rep/ModReference.html) mod, [EntitiesSaveState](EntitiesSaveState.md) saveState ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### table? TryGetEntityData ( [ModReference](https://wofsauge.github.io/IsaacDocs/rep/ModReference.html) mod, [Entity](Entity.md) entity ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }
Like `GetEntityData` but only returns a table if it already exists.

___

### TryGetEntitySaveStateData () {: aria-label='Functions' }
#### table? TryGetEntitySaveStateData ( [ModReference](https://wofsauge.github.io/IsaacDocs/rep/ModReference.html) mod, [EntitiesSaveState](EntitiesSaveState.md) saveState ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }
