...
#### int EffectClass [ ](#){: .rgonorplus .tooltip .badge }  {: .copyable aria-label='Modified Variables' }
Like the default behavior, this now returns a proper integer value instead of userdata.
...
#### int EffectSubClass [ ](#){: .rgonorplus .tooltip .badge }  {: .copyable aria-label='Modified Variables' }
Like the default behavior, this now returns a proper integer value instead of userdata.
___
