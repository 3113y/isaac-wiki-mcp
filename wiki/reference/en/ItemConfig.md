...
#### boolean CanRerollCollectible ( int ID ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### [ItemConfig_Item](ItemConfig_Item.md)[] GetTaggedItems ( int Tags ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
Returns a table of [ItemConfig_Item](ItemConfig_Item.md) objects with the specified tags.

___

### IsValidTrinket () {: aria-label='Functions' }
#### boolean IsValidTrinket ( [TrinketType](https://wofsauge.github.io/IsaacDocs/rep/enums/TrinketType.html) TrinketType ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
