...
#### float KnockbackMultiplier [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Variables'}

___

### MassMultiplier {: aria-label='Variables' }
#### float MassMultiplier [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Variables'}

___

### SpeedMultiplier {: aria-label='Variables' }
#### float SpeedMultiplier [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Variables'}

___

### TearDisplacement {: aria-label='Variables' }
#### int TearDisplacement [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Variables'}
