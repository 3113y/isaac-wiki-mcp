...
#### void AddCustomCacheTag ( string Tag ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### void AddCustomTag ( string Tag ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### table GetCustomCacheTags ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### boolean HasCustomCacheTag ( string tag ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### void RemoveCustomCacheTag ( string Tag ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### void RemoveCustomTag ( string Tag ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
