...
#### int GetCharge ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### int GetFireDelay ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### int GetMaxFireDelay ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### void PlayItemAnim ( int ItemID, [Direction](https://wofsauge.github.io/IsaacDocs/rep/enums/Direction.html) AnimDirection, [Vector](Vector.md) Position, float Charge ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### SetCharge () {: aria-label='Functions' }
#### void SetCharge ( int Charge ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
