...
#### void SetMode ( [BlendType](../enums/BlendType.md) Type ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
???+ info "Mode usages"
	The game uses:
...
#### [BlendFactor](../enums/BlendFactor.md) AlphaDestinationFactor [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Variables'}
...
#### [BlendFactor](../enums/BlendFactor.md) AlphaSourceFactor [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Variables'}
...
#### [BlendFactor](../enums/BlendFactor.md) RGBDestinationFactor [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Variables'}
`ZERO` in mode `CONSTANT`, `ONE_MINUS_SRC_ALPHA` in mode `NORMAL` and `OVERLAY`, `ONE` in mode `ADDITIVE`, and `SRC_COLOR` in `MULTIPLICATIVE`.
...
#### [BlendFactor](../enums/BlendFactor.md) RGBSourceFactor [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Variables'}
...
#### static BlendMode New ( [BlendFactor](../enums/BlendFactor.md) srcRGB, [BlendFactor](../enums/BlendFactor.md) dstRGB, [BlendFactor](../enums/BlendFactor.md) srcAlpha, [BlendFactor](../enums/BlendFactor.md) dstAlpha, [BlendEquation](../enums/BlendEquation.md) equation) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Constructors' }

___

### NewFromType () {: aria-label='Constructors' }
[ ](#){: .static .tooltip .badge }
#### static BlendMode NewFromType ( [BlendType](../enums/BlendType.md) blendType ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Constructors' }


## Functions

### Equation {: aria-label='Variables' }
#### [BlendEquation](../enums/BlendEquation.md) Equation [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Variables'}
