...
### SetStageSeed () {: aria-label='Functions' }
#### void SetStageSeed ( [LevelStage](https://wofsauge.github.io/IsaacDocs/rep/enums/LevelStage.html), int Seed ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }
