...
#### [BlendMode](renderer/BlendMode.md) GetBlendMode ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### [Vector](Vector.md) GetCropOffset ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### GetDefaultSpritesheetPath () {: aria-label='Functions' }
#### string GetDefaultSpritesheetPath ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### GetFlipX () {: aria-label='Functions' }
#### boolean GetFlipX ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### GetFlipY () {: aria-label='Functions' }
#### boolean GetFlipY ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### GetLayerID () {: aria-label='Functions' }
#### int GetLayerID ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### [Vector](Vector.md) GetPos ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### [Vector](Vector.md) GetSize ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### GetSpritesheetPath () {: aria-label='Functions' }
#### string GetSpritesheetPath ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### GetWrapSMode () {: aria-label='Functions' }
#### int GetWrapSMode ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
???+ info "信息"
    此枚举的定义尚待补充。

### GetWrapTMode () {: aria-label='Functions' }
#### int GetWrapTMode ( ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### void SetWrapTMode ( int Mode ) [ ](#){: .rgonorplus .tooltip .badge } {: .copyable aria-label='Functions' }
???+ info "信息"
    此枚举的定义尚待补充。
...
#### boolean HasCustomChampionShader ( string ShaderPath ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### boolean HasCustomShader ( string ShaderPath ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### boolean IsVisible ( ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### SetColor () {: aria-label='Functions' }
#### void SetColor ( [Color](Color.md) Color ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### SetCropOffset () {: aria-label='Functions' }
#### void SetCropOffset ( [Vector](Vector.md) Offset ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### SetCustomChampionShader () {: aria-label='Functions' }
#### void SetCustomChampionShader ( string ShaderPath ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }
Specify a custom champion shader file for this layer to use instead of the usual `coloroffset_champion` shader. The provided path is expected to start at `.../resources/` and resolve to both a .vs and .fs file at that location. For example, `layer:SetCustomChampionShader("shaders/my_shader")` loads `.../resources/shaders/my_shader.vs` and `.../resources/shaders/my_shader.fs`.
...
#### void SetCustomShader ( string ShaderPath ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }
Specify a custom shader file for this layer to use instead of the default `coloroffset` shader. The provided path is expected to start at `.../resources/` and resolve to both a .vs and .fs file at that location. For example, `layer:SetCustomShader("shaders/my_shader")` loads `.../resources/shaders/my_shader.vs` and `.../resources/shaders/my_shader.fs`.
...
#### void SetFlipX ( boolean Value ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### SetFlipY () {: aria-label='Functions' }
#### void SetFlipY ( boolean Value ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### SetPos () {: aria-label='Functions' }
#### void SetPos ( [Vector](Vector.md) Pos ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### SetRenderFlags () {: aria-label='Functions' }
#### void SetRenderFlags ( [AnimRenderFlags](enums/AnimRenderFlags.md) Flags ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### SetRotation () {: aria-label='Functions' }
#### void SetRotation ( float Rotation ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### SetSize () {: aria-label='Functions' }
#### void SetSize ( [Vector](Vector.md) Size ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### SetVisible () {: aria-label='Functions' }
#### void SetVisible ( boolean Visible ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### SetWrapSMode () {: aria-label='Functions' }
#### void SetWrapSMode ( int Mode ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }
...
#### [Image](renderer/Image.md)? GetSpritesheet ( ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }

___

### SetSpritesheet () {: aria-label='Functions' }
#### void SetSpritesheet ( [Image](renderer/Image.md) Spritesheet ) [ ](#){: .rgonplus .tooltip .badge } {: .copyable aria-label='Functions' }
